...
import cn.zbw.logistics.pojo.RoleExample.Criterion;
...
public class RoleSqlProvider {
    ...
    public String insertSelective(Role record) {
        ...
        if (record.getPermissionIds() != null) {
            sql.VALUES("permission_ids", "#{permissionIds,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Role record) {
        ...
        if (record.getPermissionIds() != null) {
            sql.SET("permission_ids = #{permissionIds,jdbcType=VARCHAR}");
        }
