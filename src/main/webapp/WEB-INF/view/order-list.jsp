...
<span class="l" id="toolbar">
	...
	<a href="javascript:;" onclick="order_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a></div>
...
<script type="text/javascript">
	...
	*/
	function operationFormatter(value,row,index){
		...
		var html = "<span onclick='order_edit("+value+")'style='cursor: pointer;' class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;&nbsp;";
		
		html += "<span onclick='order_del(this,"+value+")' style='cursor: pointer;color:red' class='glyphicon glyphicon-trash'></span>"
